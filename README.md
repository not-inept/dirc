...
Sending messages from discord does not work, and the messages themselves include the
full information from the IRC client and not exclusively the message content.
